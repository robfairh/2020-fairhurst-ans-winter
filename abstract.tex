...
However, the deterministic neutronic thermal-fluids and transient analysis tools available for the analysis of \glspl{PMR} is still 

have lagged behind

 the state of the art compared to other reactor technologies \cite{oecd_nea_benchmark_2017}.
